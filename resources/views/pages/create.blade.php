...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            <strong>seo_desc:</strong>
            {!! Form::textarea('seo_desc',null, array('placeholder' => 'seo-desc','class' => 'form-control')) !!}
        </div>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            <strong>seo-keys:</strong>
            {!! Form::textarea('seo-keys' ,null, array('placeholder' => 'seo-keys','class' => 'form-control')) !!}
        </div>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            <strong>image:</strong>
            {!! Form::file('image' ,enctype="multipart/form-data", array('placeholder' => 'image','class' => 'image')) !!}
        </div>
    </div>
